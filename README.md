# Лабораторные работы групп 3825Б1ФИип
...
2. Перейдите в созданный репозиторий и скопируйте ссылку, скрытую за кнопкой **Code**. Она должна иметь вид **`https://github.com/<Имя_вашего_аккаунта>/3825B1FIip-1_3.git`**.
...
6. - Если работаете в Visual Studio, то создайте пустой проект (или консольное приложение) с именем в виде Lab№ (например, Lab1).
...
11. Если ваша работа готова к проверке, то необходимо создать **`pull request`** из вашего репозитория в общий. В названии укажите ваши ФИО и номер лабораторной в виде ФИО Лабораторная № (например, Ивлев А.Д. Лабораторная №1). Если вы правильно назвали pull request, то рядом с названием появится метка (например, lab1).
...
14. Приём отчета выполняется совместно или после сдачи лабораторных. Отчёт сдаётся в виде pdf файла, который расположен в вашей папке с лабораторной работой. Pull request должен называться “ФИО Лабораторная №* + отчет” при совместной сдаче с лабораторной (например, Ивлев А.Д. Лабораторная №1 + отчет) или “ФИО Отчет №*” при сдаче после лабораторной (например, Ивлев А.Д. Отчет №1). Отчет считается сданным, если pull request одобрен и внесён в главную ветвь репозитория.
